...
with col1:
    valor_input = st.number_input("Enter the amount in Brazilian Reais (BRL):", min_value=0.0, value=0.0, step=10.0)

with col2:
    moeda_destino = st.selectbox("Which currency?", sorted(list(SUPPORTED)))
